...
import { Clock, MapPin, Route, RotateCcw, Navigation, ArrowRight } from 'lucide-react';
...
export default function RouteResult({ route, onReset }: RouteResultProps) {
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-600 font-mono">
                {formatCoordinate(route.start.lat, route.start.lng)}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-600 font-mono">
                {formatCoordinate(route.end.lat, route.end.lng)}
              </p>
            </div>
          </div>
        </div>
